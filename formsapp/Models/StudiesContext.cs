...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\ub8ljw\\source\\repos\\UB8LJW_zh3b\\formsapp\\StudiesDatabase.mdf;Integrated Security=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Course>(entity =>
        {
            entity.HasKey(e => e.CourseSk).HasName("PK__Course__C92D8C48E8B46AAC");
        ...
        {
            entity.HasKey(e => e.DayId).HasName("PK__Day__BF3DD8251330F996");
        ...
        {
            entity.HasKey(e => e.EmployementId).HasName("PK__Employem__BFBFF0768A3680DC");
        ...
        {
            entity.HasKey(e => e.InstructorSk).HasName("PK__Instruct__9D017A282CC8EE1D");
        ...
        {
            entity.HasKey(e => e.LessonSk).HasName("PK__Lesson__B08512E25897D8C7");
        ...
        {
            entity.HasKey(e => e.RoomSk).HasName("PK__Room__328616CF2B7A80A3");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__Status__C8EE20431ED3C1DB");
        ...
        {
            entity.HasKey(e => e.TimeId).HasName("PK__Time__E04ED9676AE33D44");
